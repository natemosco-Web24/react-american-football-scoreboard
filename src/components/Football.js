...
export default function Football() {
    ...
    const [awayTeam, setAwayTeam] = useState("Guest")

    const setup = () => {
        let homeName = () => prompt("Home Team Name?", homeTeam)
        let homeScore = () => prompt("What is the Home Team Score?", home)
        let awayName = () => prompt("Guest Team Name?", awayTeam)
        let awayScore = () => prompt("What is the Guest Team Score?", away)

        if (awayTeam === "Guest" && homeTeam === "Home") {
        ...
        <div className="container">
            <section className="scoreboard">
                <div className="topRow">
                    ...
                    <div className="away" onClick={() => setup()}>
